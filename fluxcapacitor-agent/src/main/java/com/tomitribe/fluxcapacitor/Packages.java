...
public class Packages {
    ...
    static final String apiPackage = getPackage(FluxCapacitor.class);
    static final String genPackage = apiPackage.replace(from, to);
    static final String genClass = relocate(FluxCapacitor.class);
    static final String apiClass = FluxCapacitor.class.getName().replace(".", "/");
